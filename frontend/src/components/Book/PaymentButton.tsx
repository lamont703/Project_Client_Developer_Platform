...
import '../../styles/Book/PaymentButton.css';
      ...
      <div className="payment-button-content">
        ...
        <button className="payment-cta-button">
          <div className="cta-content">
            <span className="cta-text">Get Your Copy Now</span>
        ...
        <div className="payment-features">
          <div className="payment-feature">
            ...
            <span className="feature-text">Complete Blueprint Guide</span>
          </div>
          <div className="payment-feature">
            <span className="feature-check">✓</span>
            <span className="feature-text">AI Systems & Strategies</span>
          </div>
          <div className="payment-feature">
            <span className="feature-check">✓</span>
